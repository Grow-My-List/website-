...
;
;
// 🔥 2026 TRENDING ANIMATIONS - 5 NEW STYLES
const MorphingBlobBackground = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const animate = ()=>{
            ...
            for(let i = 0; i < 3; i++){
                ctx.save();
                ctx.translate(centerX + Math.sin(time + i) * 100, centerY + Math.cos(time * 0.7 + i) * 80);
                ctx.shadowColor = `hsl(${210 + i * 30}, 70%, 55%)`;
                ctx.shadowBlur = 40;
                ctx.beginPath();
                for(let j = 0; j < 12; j++){
                    const angle = j / 12 * Math.PI * 2 + time * (0.5 + i * 0.2);
                    const radius = 80 + Math.sin(angle * 3 + time * 2) * 30 + i * 20;
                ...
                gradient.addColorStop(0, `hsla(${210 + i * 30}, 70%, 55%, 0.7)`);
                gradient.addColorStop(0.7, `hsla(${210 + i * 30}, 70%, 45%, 0.3)`);
...
const KineticTypographyBackground = ()=>{
    const canvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const canvas = canvasRef.current;
        const ctx = canvas.getContext('2d');
        ...
        window.addEventListener('resize', resize);
        const animate = ()=>{
            ctx.fillStyle = 'rgba(20, 15, 40, 0.1)';
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            time += 0.02;
            const fontSize = 120 + Math.sin(time) * 20;
            words.forEach((word, i)=>{
                const x = canvas.width / words.length * i + canvas.width / words.length / 2;
                const y = canvas.height / 2 + Math.sin(time * 1.5 + i) * 100;
                ctx.save();
                ctx.translate(x, y);
                ctx.rotate(Math.sin(time * 2 + i) * 0.3);
                ctx.shadowColor = `hsl(${280 + i * 20}, 70%, 60%)`;
                ctx.shadowBlur = 30;
                ctx.font = `bold ${fontSize}px -apple-system, sans-serif`;
                ctx.fillStyle = `hsla(${280 + i * 20}, 70%, 60%, ${0.8 + Math.sin(time * 3 + i) * 0.2})`;
...
const BentoGridBackground = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        window.addEventListener('resize', resize);
        const animate = ()=>{
            ctx.fillStyle = 'rgba(12, 15, 35, 0.12)';
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            time += 0.01;
            const cellSize = 80;
            for(let x = 0; x < canvas.width; x += cellSize){
                for(let y = 0; y < canvas.height; y += cellSize){
                    ...
                    ctx.strokeStyle = `hsla(${hue}, 70%, 55%, ${0.3 + pulse * 0.3})`;
                    ctx.lineWidth = 2 + pulse * 2;
                    ctx.strokeRect(x, y, cellSize, cellSize);
                    // Inner glow
                    ctx.shadowColor = `hsla(${hue}, 70%, 55%, 0.8)`;
                    ctx.shadowBlur = 15;
                    ctx.fillStyle = `hsla(${hue}, 70%, 55%, ${pulse * 0.2})`;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        for(let i = 0; i < 50; i++){
            streams.push({
                ...
                chars: '01<>[](){}+-*/=ReactNextjsNodeTypeScript'.split('')
            });
        }
        const animate = ()=>{
            ctx.fillStyle = 'rgba(6, 12, 35, 0.1)';
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            streams.forEach((stream)=>{
                ...
                for(let i = 0; i < 15; i++){
                    ...
                    const fontSize = 14 + i * 2;
                    const alpha = 1 - i * 0.06;
                    ctx.font = `bold ${fontSize}px monospace`;
                    ctx.fillStyle = `rgba(0, 255, 136, ${alpha})`;
                    ctx.textAlign = 'center';
                    ctx.fillText(char, stream.x, stream.y + i * 25);
                }
...
const WaveformVisualizer = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const animate = ()=>{
            ctx.fillStyle = 'rgba(8, 15, 40, 0.15)';
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            time += 0.02;
            const centerY = canvas.height / 2;
            const slices = 200;
            ...
            for(let i = 0; i < slices; i++){
                ...
                const wave1 = Math.sin((x * 0.01 + time) * 3) * 80;
                const wave2 = Math.sin((x * 0.015 + time * 1.3) * 2) * 60;
                const wave3 = Math.cos((x * 0.008 + time * 0.7) * 4) * 40;
                const y = centerY + wave1 + wave2 + wave3;
                const hue = 220 + mouseX / canvas.width * 60;
                const gradient = ctx.createLinearGradient(x, y - 100, x, y + 100);
                gradient.addColorStop(0, `hsla(${hue}, 70%, 55%, 0.9)`);
                gradient.addColorStop(1, `hsla(${hue}, 70%, 35%, 0.2)`);
                ctx.fillStyle = gradient;
...
function ProjectsPage() {
    const [activeAnimation, setActiveAnimation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const animations = [
        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(MorphingBlobBackground, {}, "blob", false, {
            fileName: "[project]/app/projects/page.tsx",
            lineNumber: 308,
            columnNumber: 5
        }, this),
        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(KineticTypographyBackground, {}, "kinetic", false, {
            fileName: "[project]/app/projects/page.tsx",
            lineNumber: 309,
            columnNumber: 5
        }, this),
        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(BentoGridBackground, {}, "bento", false, {
            fileName: "[project]/app/projects/page.tsx",
            lineNumber: 310,
            columnNumber: 5
        }, this),
        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(FloatingCodeMatrix, {}, "matrix", false, {
            fileName: "[project]/app/projects/page.tsx",
            lineNumber: 311,
            columnNumber: 5
        }, this),
        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(WaveformVisualizer, {}, "waveform", false, {
            fileName: "[project]/app/projects/page.tsx",
            lineNumber: 312,
            columnNumber: 5
        }, this)
    ...
    const currentAnimation = animations[activeAnimation % animations.length];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                id: "e2542262e6537ca8",
                children: '@keyframes magnetic{0%,to{transform:scale(1)translate(0)}50%{transform:scale(1.05)translateY(-5px)}}@keyframes tech-glow{0%,to{box-shadow:0 0 20px #6366f166}50%{box-shadow:0 0 40px #6366f1cc}}@keyframes ripple{0%{opacity:1;transform:scale(.8)}to{opacity:0;transform:scale(1.4)}}.magnetic{transition:all .3s cubic-bezier(.25,.46,.45,.94)}.magnetic:hover{animation:.6s ease-out magnetic}.tech-glow{animation:3s ease-in-out infinite tech-glow}.ripple{position:relative;overflow:hidden}.ripple:before{content:"";background:#ffffff80;border-radius:50%;width:0;height:0;animation:.6s linear ripple;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}'
            }, void 0, false, void 0, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "jsx-e2542262e6537ca8" + " " + "relative min-h-screen overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900/30 to-slate-900",
                children: [
                    currentAnimation,
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-e2542262e6537ca8" + " " + "relative z-20 min-h-screen flex flex-col",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                className: "jsx-e2542262e6537ca8" + " " + "pt-28 pb-32 text-center",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "jsx-e2542262e6537ca8" + " " + "max-w-7xl mx-auto px-6",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "jsx-e2542262e6537ca8" + " " + "inline-flex items-center gap-3 bg-white/10 backdrop-blur-xl px-8 py-4 rounded-3xl border border-white/20 mb-12 tech-glow magnetic",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "jsx-e2542262e6537ca8" + " " + "w-3 h-3 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full animate-ping [animation-duration:1.5s]"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/projects/page.tsx",
                                                    lineNumber: 361,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "jsx-e2542262e6537ca8" + " " + "text-xl font-black text-white tracking-widest uppercase",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                            className: "jsx-e2542262e6537ca8" + " " + "text-6xl md:text-7xl lg:text-8xl font-black bg-gradient-to-r from-white via-cyan-400 to-purple-400 bg-clip-text text-transparent drop-shadow-2xl mb-8 leading-tight",
                                            children: [
                                                "Cutting-Edge ",
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "jsx-e2542262e6537ca8" + " " + "text-transparent bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text",
                                                    children: "Projects"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/projects/page.tsx",
                                                    lineNumber: 366,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "jsx-e2542262e6537ca8" + " " + "text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed",
                                            children: "Next-generation web experiences built with modern techniques and smooth animations"
                                        }, void 0, false, {
                                            fileName: "[project]/app/projects/page.tsx",
                                            lineNumber: 369,
                                            columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                className: "jsx-e2542262e6537ca8" + " " + "py-24 border-t border-white/10",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "jsx-e2542262e6537ca8" + " " + "max-w-7xl mx-auto px-6",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-e2542262e6537ca8" + " " + "grid grid-cols-2 lg:grid-cols-4 gap-8",
                                        children: [
                                            {
                                                num: '127+',
                                                label: 'Live Projects',
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "jsx-e2542262e6537ca8" + " " + "group p-8 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 hover:bg-white/10 hover:scale-105 transition-all duration-500 magnetic",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(IconComp, {
                                                        className: "jsx-e2542262e6537ca8" + " " + "w-14 h-14 mx-auto mb-6 text-cyan-400 opacity-80 group-hover:opacity-100 transition-all group-hover:scale-110"
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/projects/page.tsx",
                                                        lineNumber: 388,
                                                        columnNumber: 23
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "jsx-e2542262e6537ca8" + " " + "text-4xl lg:text-5xl font-black text-white mb-3",
                                                        children: stat.num
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/projects/page.tsx",
                                                        lineNumber: 389,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "jsx-e2542262e6537ca8" + " " + "text-white/70 text-lg font-medium",
                                                        children: stat.label
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/projects/page.tsx",
                                                        lineNumber: 390,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                className: "jsx-e2542262e6537ca8" + " " + "py-32 flex-1",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "jsx-e2542262e6537ca8" + " " + "max-w-6xl mx-auto px-6",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "jsx-e2542262e6537ca8" + " " + "group bg-white/5 backdrop-blur-3xl rounded-4xl border border-white/10 overflow-hidden hover:bg-white/10 hover:scale-[1.02] transition-all duration-1000 ripple magnetic",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "jsx-e2542262e6537ca8" + " " + "grid lg:grid-cols-2 items-center p-2 lg:p-16 gap-12",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "jsx-e2542262e6537ca8" + " " + `relative rounded-4xl p-24 flex items-center justify-center group-hover:scale-110 transition-all duration-1000 ${project.gradient}`,
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Icon, {
                                                                className: "jsx-e2542262e6537ca8" + " " + "w-36 h-36 text-white/20 group-hover:text-white/60 transition-all duration-700"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/projects/page.tsx",
                                                                lineNumber: 404,
                                                                columnNumber: 21
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "jsx-e2542262e6537ca8" + " " + "absolute inset-0 bg-gradient-to-r from-white/20 opacity-0 group-hover:opacity-100 transition-all duration-700 backdrop-blur-sm rounded-4xl"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/projects/page.tsx",
                                                                lineNumber: 405,
                                                                columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "jsx-e2542262e6537ca8" + " " + "space-y-8",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "jsx-e2542262e6537ca8" + " " + "flex items-center gap-4",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "jsx-e2542262e6537ca8" + " " + "w-5 h-5 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full shadow-lg animate-ping"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/projects/page.tsx",
                                                                        lineNumber: 410,
                                                                        columnNumber: 23
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "jsx-e2542262e6537ca8" + " " + "px-8 py-4 bg-emerald-500/15 text-emerald-400 rounded-3xl font-black text-lg tracking-wide border-2 border-emerald-500/30 backdrop-blur-xl",
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                                                className: "jsx-e2542262e6537ca8" + " " + "text-5xl lg:text-6xl font-black bg-gradient-to-r from-white via-cyan-300 to-emerald-300 bg-clip-text text-transparent drop-shadow-2xl leading-tight",
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "jsx-e2542262e6537ca8" + " " + "grid grid-cols-1 lg:grid-cols-2 gap-8 pb-12 border-b-2 border-white/5",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "jsx-e2542262e6537ca8",
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                                                className: "jsx-e2542262e6537ca8" + " " + "flex items-center gap-3 text-2xl font-black text-white mb-6",
                                                                                children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                className: "jsx-e2542262e6537ca8" + " " + "space-y-4",
                                                                                children: [
                                                                                    '99.9% Uptime',
                                                                                    '3x Faster',
                                                                                    '50K+ Users'
                                                                                        ...
                                                                                        className: "jsx-e2542262e6537ca8" + " " + "flex items-center gap-4 p-6 bg-white/5 rounded-2xl hover:bg-white/10 transition-all group",
                                                                                        children: [
                                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                                className: "jsx-e2542262e6537ca8" + " " + "w-4 h-4 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full shadow-lg"
                                                                                            }, void 0, false, {
                                                                                                fileName: "[project]/app/projects/page.tsx",
                                                                                                lineNumber: 429,
                                                                                                columnNumber: 31
                                                                                            ...
                                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                                className: "jsx-e2542262e6537ca8" + " " + "font-semibold text-lg text-white",
                                                                                                children: metric
                                                                                            }, void 0, false, {
                                                                                                fileName: "[project]/app/projects/page.tsx",
                                                                                                lineNumber: 430,
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "jsx-e2542262e6537ca8" + " " + "space-y-6 pt-4",
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                className: "jsx-e2542262e6537ca8" + " " + "flex flex-wrap gap-3",
                                                                                children: [
                                                                                    'React',
                                                                                    'Next.js',
                                                                                    'TypeScript',
                                                                                    ...
                                                                                    'tRPC'
                                                                                        ...
                                                                                        className: "jsx-e2542262e6537ca8" + " " + "px-5 py-3 bg-white/10 hover:bg-white/20 text-sm font-mono font-bold rounded-2xl border border-white/20 transition-all hover:scale-105 magnetic",
                                                                                        children: tag
                                                                                    }, tag, false, {
                                                                                        fileName: "[project]/app/projects/page.tsx",
                                                                                        lineNumber: 439,
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                className: "jsx-e2542262e6537ca8" + " " + "flex flex-col sm:flex-row gap-4",
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                                                        size: "lg",
                                                                                        className: "flex-1 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 font-black text-lg py-8 shadow-2xl ripple",
                                                                                        children: "View Live →"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/app/projects/page.tsx",
                                                                                        lineNumber: 446,
                                                                                    ...
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                                                        variant: "outline",
                                                                                        size: "lg",
                                                                                        className: "flex-1 border-white/30 text-white hover:bg-white/10 font-black text-lg py-8 backdrop-blur-xl",
                                                                                        children: "Case Study"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/app/projects/page.tsx",
                                                                                        lineNumber: 449,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "jsx-e2542262e6537ca8" + " " + "flex justify-center gap-4 mt-24 pb-24",
                                            children: projects.map((_, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    className: "jsx-e2542262e6537ca8" + " " + `relative overflow-hidden transition-all duration-700 h-4 rounded-full ${activeProject === i ? 'w-32 h-8 bg-gradient-to-r from-emerald-400 via-cyan-400 to-purple-400 shadow-xl scale-125' : 'w-4 h-4 bg-white/40 hover:bg-white/70 hover:w-12 hover:h-6'}`
                                                }, i, false, {
                                                    fileName: "[project]/app/projects/page.tsx",
                                                    lineNumber: 462,
                                                    columnNumber: 19
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                className: "jsx-e2542262e6537ca8" + " " + "py-32 relative overflow-hidden",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-e2542262e6537ca8" + " " + "absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"
                                    }, void 0, false, {
                                        fileName: "[project]/app/projects/page.tsx",
                                        lineNumber: 478,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-e2542262e6537ca8" + " " + "max-w-4xl mx-auto px-6 text-center relative z-10",
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "jsx-e2542262e6537ca8" + " " + "bg-white/5 backdrop-blur-3xl p-20 rounded-4xl border border-white/10 tech-glow",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "jsx-e2542262e6537ca8" + " " + "w-28 h-28 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-4xl flex items-center justify-center mx-auto mb-12 shadow-2xl",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                                    className: "jsx-e2542262e6537ca8" + " " + "text-6xl lg:text-7xl font-black bg-gradient-to-r from-white via-emerald-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-4xl mb-8",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "jsx-e2542262e6537ca8" + " " + "text-2xl text-white/80 mb-16 max-w-2xl mx-auto leading-relaxed",
                                                    children: "Transform your vision into reality with cutting-edge technology"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/projects/page.tsx",
                                                    lineNumber: 489,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "jsx-e2542262e6537ca8" + " " + "flex flex-col lg:flex-row gap-8 justify-center items-center",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                            size: "xl",
                                                            className: "bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 text-white font-black text-2xl px-16 py-12 rounded-3xl shadow-2xl hover:shadow-emerald-500/50 hover:scale-105 transition-all duration-500 ripple h-auto",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "jsx-e2542262e6537ca8",
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$right$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowRight$3e$__["ArrowRight"], {
                                                                    className: "ml-4 w-8 h-8 group-hover:translate-x-3 transition-all duration-500"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/projects/page.tsx",
                                                                    lineNumber: 496,
                                                                    columnNumber: 21
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                            size: "xl",
                                                            variant: "outline",
                                                            className: "border-white/30 text-white backdrop-blur-xl font-black text-xl px-12 py-10 rounded-3xl shadow-2xl hover:bg-white/10 h-auto border-2",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "jsx-e2542262e6537ca8",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-e2542262e6537ca8" + " " + "fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50 flex gap-3 bg-white/10 backdrop-blur-xl rounded-3xl p-4 border border-white/20",
                        children: [
                            'Morph Blobs',
                            'Kinetic Text',
                            'Bento Grid',
                            'Code Matrix',
                            'Waveform'
                        ].map((name, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: ()=>setActiveAnimation(i),
                                className: "jsx-e2542262e6537ca8" + " " + `px-6 py-3 rounded-2xl text-sm font-bold transition-all backdrop-blur-xl ${activeAnimation === i ? 'bg-white text-slate-900 shadow-2xl scale-105 border-2 border-white/50' : 'text-white/90 hover:bg-white/20 hover:text-white border border-white/20'}`,
                                children: name
                            }, name, false, {
                                fileName: "[project]/app/projects/page.tsx",
                                lineNumber: 511,
...
//# sourceMappingURL=_2a56468c._.js.map